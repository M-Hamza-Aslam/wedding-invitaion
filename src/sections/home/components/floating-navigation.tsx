  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white/90 backdrop-blur-md rounded-xl sm:rounded-2xl px-1.5 sm:px-2 py-1.5 sm:py-2 shadow-xl border border-white/40 hover:shadow-2xl transition-all duration-300"
      >
